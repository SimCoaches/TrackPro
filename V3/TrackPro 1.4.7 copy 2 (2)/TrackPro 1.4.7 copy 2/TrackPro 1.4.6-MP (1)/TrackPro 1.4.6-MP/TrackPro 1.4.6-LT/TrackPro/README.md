...
1. Run `TrackPro_Setup_v1.4.6.exe` as Administrator
...
## Important Notes
- The application requires both vJoy and HidHide drivers to function properly
- Always run the application as Administrator for full functionality
- If you encounter any issues, please check the troubleshooting guide in the documentation
