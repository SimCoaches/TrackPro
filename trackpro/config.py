...
DEFAULT_CONFIG = {
    'supabase': {
        ...
        'url': 'https://xjpewnaxszuqluhdhusf.supabase.co',
        'key': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InhqcGV3bmF4c3p1cWx1aGRodXNmIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDA1MTI4NzUsImV4cCI6MjA1NjA4ODg3NX0.2RcZ2m1kMm7S41de-xmwi_-_EO8ae6jkSHiAdV3ayGU'
    }
}
