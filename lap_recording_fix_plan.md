...
- [x] Do a live session, verify console logs show: "Finalised lap 5 (TIMED, 78.432 s)" immediately after SF crossing, even though no lap 6 ever started.
- [x] Confirm Supabase shows OUT-lap rows where expected and no gap in lap numbers.
...
- [x] Live verification pass: 1 h
- [x] Supabase schema alignment fix: 0.5 h
- [x] Final production build and deployment: 0.5 h
- [x] Total (with buffer): 1 working day + 0.5 h for unexpected fixes
