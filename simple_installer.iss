...
DisableDirPage=no
AllowNoIcons=no
OutputBaseFilename=TrackPro_Setup_v1.5.6
OutputDir=.
...
[Files]
Source: "installer_temp\dist\TrackPro_v1.5.6.exe"; DestDir: "{app}"; Flags: ignoreversion
...
begin
  ...
  try
    ...
    OldShortcuts.Add(ExpandConstant('{userdesktop}') + '\TrackPro.lnk');
        ...
        // Also check for v1.5.6 shortcuts
        OldShortcuts.Add(ExpandConstant('{group}') + '\TrackPro v1.5.6.lnk');
        OldShortcuts.Add(ExpandConstant('{commondesktop}') + '\TrackPro v1.5.6.lnk');
        OldShortcuts.Add(ExpandConstant('{userdesktop}') + '\TrackPro v1.5.6.lnk');
...
Name: "{commondesktop}\TrackPro"; Filename: "{app}\TrackPro_v1.5.6.exe"; WorkingDir: "{app}"; Comment: "TrackPro Racing Coach Application"; Tasks: desktopicon; Flags: createonlyiffileexists
